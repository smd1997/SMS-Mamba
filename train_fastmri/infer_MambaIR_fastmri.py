...
if __name__ == "__main__":
    ...
    # Checking paths
    args.useslice = True
    args.eval_model = 'model502024-08-16-07_01_51'
    args.model_folder = '2024-08-09-14_53_06preprocessed_knee_singlecoil_8x_0.04c320x320_MambaIR'
    ...
    infer_dataset = FastmriDatasetforMambaIR(rootpath=Fastmri_path, 
    ...
    with torch.no_grad():
        with tqdm(total=len(infer_dataloader)) as pbar:
            for batch_idx, [input, label] in enumerate(infer_dataloader):
                torch.cuda.empty_cache()
