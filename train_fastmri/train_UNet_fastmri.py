...
if __name__ == "__main__":
    ...
    parser.add_argument('-iter', type=int, default=4, required=False, help='iteration')
    ...
    parser.add_argument('-pre_name', type=str, default='Unet_SMS_4x_384x384', required=False, help='preprossed folder name')
    ...
    if args.amp == 'fp16':
        ...
        scaler = None
    # args.model_folder = "2024-07-06-14:42:22preprocessed_knee_singlecoil_8x_0.04c320x320_UNet_unrolled_AM"
    ...
    if args.c or args.eval:
        ...
        start_ep = 0
        Cur_model_path = os.path.join(Cur_model_path, get_time()+args.pre_name+'_UNet_unrolled_'+args.dctype + args.expname)
