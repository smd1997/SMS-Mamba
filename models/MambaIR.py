...
class MambaIR(nn.Module):
    ...
    def forward(self, x):
        ...
        # plt.imshow(x[0,0,:,:].detach().cpu().numpy(), cmap=plt.cm.gray);plt.savefig(r'/mnt/data/zlt/AR-Recon/rec.jpg');plt.close()
        return x
...
if __name__ == "__main__":
    ...
    model = buildMambaIR(upscale=1).to(device)
    output = model(input)
    print()
